  ...
  return (
    <>
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <p className="text-lg text-gray-300" style={{ fontFamily: "'Roboto Mono', monospace" }}>
      ...
      <section className="w-full flex flex-col items-center py-16 px-4 sm:px-8 lg:px-20 gap-12" style={{ backgroundColor: '#151515' }}>
        <div className="text-center flex flex-col items-center gap-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-8 w-full max-w-7xl">
          <form action={handleFormSubmit} className="flex-1 p-6 flex flex-col gap-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
            <div className="flex flex-col gap-4">
              <label htmlFor="name" className="text-xl md:text-2xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Name</label>
              <div className="flex items-center p-4 gap-4 bg-[#242424] border border-[#424242] rounded">
                <UserIcon />
                <input id="name" name="name" type="text" placeholder="Enter Your Name" className="bg-transparent text-white placeholder-gray-500 outline-none w-full" required />
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="email" className="text-xl md:text-2xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Email</label>
              <div className="flex items-center p-4 gap-4 bg-[#242424] rounded">
                <MailIcon />
                <input id="email" name="email" type="email" placeholder="Enter your email address" className="bg-transparent text-white placeholder-gray-500 outline-none w-full" required />
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="phone" className="text-xl md:text-2xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Phone Number</label>
              <div className="flex items-center p-4 gap-4 bg-[#242424] rounded">
                <PhoneIcon />
                <input id="phone" name="phone" type="tel" placeholder="Enter your phone number" className="bg-transparent text-white placeholder-gray-500 outline-none w-full" required />
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="company" className="text-xl md:text-2xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Company Name</label>
              <div className="flex items-center p-4 gap-4 bg-[#242424] rounded">
                <CompanyIcon />
                <input id="company" name="company" type="text" placeholder="Enter your company name" className="bg-transparent text-white placeholder-gray-500 outline-none w-full" required />
              </div>
            </div>
            <button 
              type="submit"
              className="py-4 px-8 bg-[#2C76E5] text-white text-xl md:text-2xl disabled:bg-gray-500" 
            ...
            <div className="p-8 flex-1 flex flex-col gap-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-start gap-6">
                  <CalendarIcon />
                  <div className="flex flex-col gap-4">
                    <h4 className="text-lg md:text-xl font-bold text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>Strategy Session</h4>
                    <p className="text-base md:text-xl text-gray-400" style={{ fontFamily: "'Roboto Mono', monospace" }}>Free consultation to discuss your LinkedIn goals</p>
                  </div>
                </div>
              </div>
            </div>
