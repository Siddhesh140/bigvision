      ...
      <div className="flex flex-col md:flex-row gap-7 w-full max-w-7xl">
        ...
        <div className="flex-1 flex flex-col justify-between p-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-base md:text-lg font-bold text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>Karthikeyan Jawahar</p>
              <p className="text-sm md:text-base text-gray-400" style={{ fontFamily: "'Roboto Mono', monospace" }}>Director, Karma Innovations</p>
            </div>
          </div>
        </div>
        {/* Card 2 */}
        <div className="flex-1 flex flex-col justify-between p-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-base md:text-lg font-bold text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>Anand Mulay</p>
              <p className="text-sm md:text-base text-gray-400" style={{ fontFamily: "'Roboto Mono', monospace" }}>MD, Renuka Tools</p>
            </div>
          </div>
        </div>
        {/* Card 3 */}
        <div className="flex-1 flex flex-col justify-between p-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-base md:text-lg font-bold text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>Dinesh Alone</p>
              <p className="text-sm md:text-base text-gray-400" style={{ fontFamily: "'Roboto Mono', monospace" }}>Director, Vibex Machines</p>
            </div>
          </div>
        </div>
      </div>
