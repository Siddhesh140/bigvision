...
const WhyBigVision = () => {
  return (
    <>
      ...
      <section className="w-full flex flex-col items-center py-16 px-4 sm:px-8 lg:px-20 gap-12" style={{ backgroundColor: '#151515' }}>
        <div className="text-center flex flex-col items-center gap-8">
          <h2 className="text-4xl md:text-6xl font-bold text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>
            Why Big Vision?
          </h2>
          <p className="text-lg md:text-xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>
            No fluff. Just focused execution.
          </p>
          <p className="text-xl md:text-2xl text-white max-w-3xl mt-4" style={{ fontFamily: "'Montserrat', sans-serif" }}>
        ...
        <div className="relative w-full max-w-7xl h-[400px] md:h-[644px]">
          ...
          <div className="absolute bottom-8 left-8 md:bottom-14 md:left-14 z-10 text-white">
            <h3 className="text-2xl md:text-4xl font-bold" style={{ fontFamily: "'Montserrat', sans-serif" }}>
              We make social media work like sales.
            </h3>
            <p className="text-base md:text-xl mt-4" style={{ fontFamily: "'Roboto Mono', monospace" }}>
        ...
        <div className="flex flex-col md:flex-row gap-7 w-full max-w-7xl">
          <div className="flex-1 flex flex-col p-8 md:p-12 gap-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
            <div className="relative w-12 h-12">
              <Image src="/logo100.png" alt="Leads Icon" layout="fill" objectFit="contain" />
            </div>
            <div className="flex flex-col gap-4">
              <p className="text-4xl md:text-6xl font-medium text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>4000+</p>
              <p className="text-xl md:text-3xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>B2B leads</p>
            </div>
          </div>
          <div className="flex-1 flex flex-col p-8 md:p-12 gap-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
            <div className="relative w-12 h-12">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-4xl md:text-6xl font-medium text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>12+</p>
              <p className="text-xl md:text-3xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Brands scaled</p>
            </div>
          </div>
          <div className="flex-1 flex flex-col p-8 md:p-12 gap-8 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
            <div className="relative w-12 h-12">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-4xl md:text-6xl font-medium text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>75%+</p>
              <p className="text-xl md:text-3xl text-white" style={{ fontFamily: "'Roboto Mono', monospace" }}>Conversions</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex flex-col items-center py-16 px-4 sm:px-8 lg:px-20" style={{ backgroundColor: '#151515' }}>
        <div className="flex flex-col lg:flex-row gap-16 w-full max-w-7xl">
          {/* Left Column */}
          <div className="flex-1 p-8 md:p-10 flex flex-col gap-10 rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]" style={{ backgroundColor: '#191919' }}>
            <div className="flex flex-col gap-4">
              <h3 className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: "'Integral CF', sans-serif" }}>Who We Work With</h3>
              <p className="text-xl md:text-2xl text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>We specialize in scaling B2B brands in:</p>
            </div>
            <div className="flex flex-col gap-8">
              <div className="flex items-start gap-4"><CheckIcon /> <p className="text-base md:text-xl text-white flex-1" style={{ fontFamily: "'Roboto Mono', monospace" }}>Manufacturing (automotive, aerospace, tooling, X-ray, robotics)</p></div>
              <div className="flex items-center gap-4"><CheckIcon /> <p className="text-base md:text-xl text-white flex-1" style={{ fontFamily: "'Roboto Mono', monospace" }}>Industrial SaaS & Tech for factories</p></div>
              <div className="flex items-start gap-4"><CheckIcon /> <p className="text-base md:text-xl text-white flex-1" style={{ fontFamily: "'Roboto Mono', monospace" }}>MSME / SME founders targeting global growth</p></div>
              <div className="flex items-start gap-4"><CheckIcon /> <p className="text-base md:text-xl text-white flex-1" style={{ fontFamily: "'Roboto Mono', monospace" }}>Founders/MDs seeking a stronger LinkedIn presence</p></div>
            </div>
          </div>
          {/* Right Column */}
          <div className="flex-1 p-8 md:p-10 flex flex-col gap-10 bg-gray-100 text-black rounded-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-[0_0_35px_rgba(59,130,246,0.4)]">
            <div className="flex flex-col gap-4">
              <h3 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "'Integral CF', sans-serif" }}>What Makes Us Different</h3>
              <p className="text-xl md:text-2xl" style={{ fontFamily: "'Montserrat', sans-serif" }}>One partner. One plan. All execution.</p>
            </div>
            <div className="flex flex-col gap-8">
      ...
      <section className="w-full flex flex-col items-center py-16 px-4 sm:px-8 lg:px-20" style={{ backgroundColor: '#151515' }}>
        <div className="flex flex-col lg:flex-row justify-between items-center w-full max-w-7xl gap-12">
            ...
            >
                <CalendarIcon />
                <span className="text-base md:text-lg font-bold" style={{ fontFamily: "'Montserrat', sans-serif" }}>
